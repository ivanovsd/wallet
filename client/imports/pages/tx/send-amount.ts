...
// import template from './send-amount.html';
...
export class TxSendAmountPage implements OnInit {
  sendForm: FormGroup;
  recipient: string = '';
  walletId: string;
  walletName: string;
  ...
  send() {
    if (this.sendForm.valid) {
      let amount = this.sendForm.value.amount;
      this.router.navigate(['/send-confirm', this.recipient, amount]);
    }
